...
public class RuleActivity extends BaseActivity {
    ...
    @BindView(R.id.et_rule_worked)
    EditText etRuleWorked;
    @BindView(R.id.et_rule_breaked)
    EditText etRuleBreaked;
    @BindView(R.id.sp_rule_interval)
    Spinner spRuleInterval;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar(getWindow().getDecorView(),"Rule",getDrawable(R.drawable.ic_back_white_24dp),getDrawable(R.drawable.ic_save_white_24dp));
    }
