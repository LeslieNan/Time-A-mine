...
import com.zkteco.android.framework.db.liteorm.db.assit.Querier.CursorParser;
...
public class SQLStatement implements Serializable {
    ...
    public long execInsertWithMapping(SQLiteDatabase db, Object entity, TableManager tableManager)
        ...
        Object keyObj = null;
        if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(bindArgs)) {
            keyObj = bindArgs[0];
    ...
    public int execUpdateCollectionWithMapping(SQLiteDatabase db, Collection<?> list,
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                bindArgs = com.zkteco.android.framework.db.liteorm.db.assit.SQLBuilder.buildUpdateSqlArgsOnly(obj, cvs);
                if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(bindArgs)) {
                    for (int i = 0; i < bindArgs.length; i++) {
                        bind(i + 1, bindArgs[i]);
                    }
    ...
    public int execDeleteCollectionWithMapping(final SQLiteDatabase db, final Collection<?> collection,
        ...
        if (tableManager != null) {
            // 删除关系映射
            Boolean suc = com.zkteco.android.framework.db.liteorm.db.assit.Transaction.execute(db, new com.zkteco.android.framework.db.liteorm.db.assit.Transaction.Worker<Boolean>() {
                @Override
    ...
    public <T> ArrayList<T> query(SQLiteDatabase db, final Class<T> claxx) {
        ...
        try {
            ...
            com.zkteco.android.framework.db.liteorm.db.assit.Querier.doQuery(db, this, new CursorParser() {
                @Override
    ...
    private void mapRelationToDb(Object entity, final boolean insertNew,
        ...
        if (mapTable != null && !mapTable.isEmpty()) {
            com.zkteco.android.framework.db.liteorm.db.assit.Transaction.execute(db, new Transaction.Worker<Boolean>() {
                @Override
                public Boolean doTransaction(SQLiteDatabase db) throws Exception {
