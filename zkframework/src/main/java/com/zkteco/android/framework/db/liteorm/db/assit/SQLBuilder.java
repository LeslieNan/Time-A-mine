package com.zkteco.android.framework.db.liteorm.db.assit;

import android.util.SparseArray;

import com.zkteco.android.framework.db.liteorm.db.TableManager;
import com.zkteco.android.framework.db.liteorm.db.annotation.Check;
import com.zkteco.android.framework.db.liteorm.db.annotation.Collate;
import com.zkteco.android.framework.db.liteorm.db.annotation.Conflict;
import com.zkteco.android.framework.db.liteorm.db.annotation.Default;
import com.zkteco.android.framework.db.liteorm.db.annotation.NotNull;
import com.zkteco.android.framework.db.liteorm.db.annotation.Temporary;
import com.zkteco.android.framework.db.liteorm.db.annotation.Unique;
import com.zkteco.android.framework.db.liteorm.db.annotation.UniqueCombine;
import com.zkteco.android.framework.db.liteorm.db.enums.AssignType;
import com.zkteco.android.framework.db.liteorm.db.model.ColumnsValue;
import com.zkteco.android.framework.db.liteorm.db.model.ConflictAlgorithm;
import com.zkteco.android.framework.db.liteorm.db.model.EntityTable;
import com.zkteco.android.framework.db.liteorm.db.model.MapInfo;
import com.zkteco.android.framework.db.liteorm.db.model.MapInfo.MapTable;
import com.zkteco.android.framework.db.liteorm.db.model.MapProperty;
import com.zkteco.android.framework.db.liteorm.db.model.Property;
import com.zkteco.android.framework.db.liteorm.db.utils.ClassUtil;
import com.zkteco.android.framework.db.liteorm.db.utils.DataUtil;
import com.zkteco.android.framework.db.liteorm.db.utils.FieldUtil;
...
public class SQLBuilder {
    ...
    public static SQLStatement buildCreateTable(EntityTable table) {
        ...
        if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(table.pmap)) {
            if (hasKey) {
                sb.append(COMMA);
            }
    ...
    private static SQLStatement buildUpdateSql(Object entity, ColumnsValue cvs,
        ...
        try {
            ...
            } else if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(table.pmap)) {
                if (needValue) {
                    size += table.pmap.size();
                    args = new Object[size];
                }
    ...
    public static SQLStatement buildDeleteSql(Class<?> claxx, long start, long end, String orderAscColumn) {
        ...
        String orderBy = com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(orderAscColumn) ? key : orderAscColumn;
        StringBuilder sb = new StringBuilder();
    ...
    public static MapInfo buildDelAllMappingSql(Class claxx) {
        ...
        if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(table1.mappingList)) {
            try {
                    ...
                    if (insertNew) {
                        ...
                        if (mapObject != null) {
                            if (map.isToMany()) {
                                ...
                                if (com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(sqlList)) {
    ...
    private static SQLStatement buildMappingToManySqlFragment(Object key1, EntityTable table1,
        ...
        String mapTableName = TableManager.getMapTableName(table1, table2);
        if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(coll)) {
            boolean isF = true;
            ...
            if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(args)) {
                SQLStatement stmt = new SQLStatement();
    ...
    private static SQLStatement buildQueryRelationSql(Class class1, Class class2,
        ...
        if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(key1List)) {
        ...
        if (!com.zkteco.android.framework.db.liteorm.db.assit.Checker.isEmpty(key2List)) {
            if (sb == null) {
                sb = new StringBuilder();
            } else {
                sb.append(AND);
