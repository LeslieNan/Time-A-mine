package com.zkteco.android.framework.db.liteorm.db.impl;

import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.zkteco.android.framework.db.liteorm.LiteOrm;
...
import com.zkteco.android.framework.db.liteorm.db.assit.Transaction;
import com.zkteco.android.framework.db.liteorm.db.assit.Transaction.Worker;
...
public final class CascadeSQLiteImpl extends LiteOrm {
    ...
    public LiteOrm single() {
        if (otherDatabase == null) {
            otherDatabase = new com.zkteco.android.framework.db.liteorm.db.impl.SingleSQLiteImpl(this);
        }
