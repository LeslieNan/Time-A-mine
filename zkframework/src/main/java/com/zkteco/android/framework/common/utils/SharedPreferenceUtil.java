...
public class SharedPreferenceUtil {
	...
	public static int MODE_READABLE_WRITEABLE = Context.MODE_WORLD_READABLE+ Context.MODE_WORLD_WRITEABLE;
	/**
	...
	public static String getString(Context context, String fileName,
		...
		if(!contailByDefault){
			SharedPreferences sharedPreferences = getDefaultSharedPreferences(context, fileName, key, mode);
			return sharedPreferences.getString(key, defaultValue);
		}

		SharedPreferences pre = getSharedPreferences(context, fileName, key, mode);
...
//			int mode) {
//		SharedPreferences pre = getSharedPreferences(context, fileName, null, mode);
//		return pre.getAll();
//	}
//
//	/**
...
//	}
	...
	/**
	 * @see #setBooleanValue(Context, String, String,
	 *      boolean, int)
	 */
	public static void setBooleanValue(Context context, String fileName,
	...
	/**
	 * @see #setLongValue(Context, String, String, long,
	 *      int)
	 */
	public static void setLongValue(Context context, String fileName,
	...
	/**
	 * @see #setFloatValue(Context, String, String, float,
	 *      int)
	 */
...
//	}
	 ...
	 * @return
	 */
	public static boolean contain(Context context,String fileName,String key,int mode){
	 ...
	 * @param mode
	 */
	public static void remove(Context context, String fileName, String key, int mode){
		File file = getSharedPreferenceItem(context, key);
		if(file != null){
			file.delete();
		}
	...
	private static boolean containByNew(Context context, String fileName, String key){
		boolean containNew = contain(context, fileName, key);
		return containNew;
	}

	private static SharedPreferences getDefaultSharedPreferences(Context context, String fileName, String key, int mode){
		if (fileName == null) {
			return PreferenceManager.getDefaultSharedPreferences(context);
		} else {
			return context.getSharedPreferences(fileName, mode);
